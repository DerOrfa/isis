...
// $insert polymorphicSpecializations
    ...
    {
        static Tag__ const tag = Tag__::SPAIR;
    };

    template <>
    struct TagOf<std::list<std::string>>
    {
        static Tag__ const tag = Tag__::SLIST;
    };

    template <>
    struct TagOf<isis::util::PropertyMap>
    {
        static Tag__ const tag = Tag__::MAP;
    };
    ...
    template <>
    struct TypeOf<Tag__::SPAIR>
    {
        typedef std::pair<std::string,std::string> type;
    };

    template <>
    struct TypeOf<Tag__::SLIST>
    {
        typedef std::list<std::string> type;
    };

    template <>
    struct TypeOf<Tag__::MAP>
    {
        typedef isis::util::PropertyMap type;
    };
