// Generated by Flexc++ V2.03.04 on Fri, 11 Nov 2016 14:09:25 +0100
...
private:
    ...
    size_t (VistaScannerBase::*d_get)() = &VistaScannerBase::getInput;
...
public:
    VistaScannerBase(VistaScannerBase const &other)             = delete;
    VistaScannerBase &operator=(VistaScannerBase const &rhs)    = delete;
...
protected:
    VistaScannerBase(std::istream &in, std::ostream &out);
    VistaScannerBase(std::string const &infilename, std::string const &outfilename);
    ~VistaScannerBase();
...
inline VistaScannerBase::~VistaScannerBase()
{
    d_input.close();
}

template <typename ReturnType, typename ArgType>
inline ReturnType constexpr VistaScannerBase::as(ArgType value)
{
    return static_cast<ReturnType>(value);
}

inline bool VistaScannerBase::knownFinalState()
{
    return (d_atBOL && available(d_final.bol.rule)) ||
           available(d_final.std.rule);
}

inline bool constexpr VistaScannerBase::available(size_t value)
{   
    return value != std::numeric_limits<size_t>::max();
}

inline VistaScannerBase::StartCondition__ constexpr VistaScannerBase::SC(int sc)
{
    return as<StartCondition__>(sc);
}

inline int constexpr VistaScannerBase::SC(StartCondition__ sc)
{
    return as<int>(sc);
}

inline std::ostream &VistaScannerBase::out()
{
    return *d_out;
}

inline void VistaScannerBase::push(size_t ch)
{
    d_input.reRead(ch);
}

inline void VistaScannerBase::push(std::string const &str)
{
    d_input.reRead(str, 0);
}

inline void VistaScannerBase::setFilename(std::string const &name)
{
    d_filename = name;
}

inline void VistaScannerBase::setMatched(std::string const &text)
{
    d_matched = text;
}

inline std::string const &VistaScannerBase::matched() const
{
    return d_matched;
}

inline VistaScannerBase::StartCondition__ VistaScannerBase::startCondition() const
{
    return SC(d_startCondition);
}

inline std::string const &VistaScannerBase::filename() const
{
    return d_filename;
}

inline void VistaScannerBase::echo() const
{
    *d_out << d_matched;
}

inline size_t VistaScannerBase::length() const
{
    return d_matched.size();
}

inline void VistaScannerBase::leave(int retValue) const
{
    throw as<Leave__>(retValue);
}

inline size_t VistaScannerBase::lineNr() const
{
    return d_input.lineNr();
}

inline void VistaScannerBase::more()
{
    d_more = true;
}

inline void VistaScannerBase::begin(StartCondition__ startCondition)
{
    // d_state is reset to 0 by reset__()
    d_dfaBase__ = s_dfaBase__[d_startCondition = SC(startCondition)];
}

inline size_t VistaScannerBase::state__() const
{
    return d_state;
}

inline size_t VistaScannerBase::get__()
{
    return (this->*d_get)();
}

inline size_t VistaScannerBase::getInput()
{
    return d_input.get();
}

inline bool VistaScannerBase::return__()
{
    return d_return;
}

inline void VistaScannerBase::noReturn__()
{
    d_return = false;
}
